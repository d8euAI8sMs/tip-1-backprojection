...
| pdf report | project |
| ---------- | ------- |
| [![Build status](https://ci.appveyor.com/api/projects/status/1n2vfw3i1l7mp23x?svg=true)](https://ci.appveyor.com/project/kalaider/learning/build/artifacts) | [![Build status](https://ci.appveyor.com/api/projects/status/jh2bk4awxe2dn08t?svg=true)](https://ci.appveyor.com/project/kalaider/tip-1-backprojection/build/artifacts) |
